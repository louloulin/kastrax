...
class SchemaJsonExtensionsTest {
    ...
    fun `ArraySchema should convert to JSON Schema`() {
        ...
        schema.minLength = 1
        schema.maxLength = 5
        schema.description = "A test array"
    ...
    fun `TupleSchema should convert to JSON Schema`() {
        val schema = TupleSchema(listOf(StringSchema(), NumberSchema(), BooleanSchema()))
        schema.description = "A test tuple"
    ...
    fun `UnionSchema should convert to JSON Schema`() {
        ...
        schema.description = "A test union"
