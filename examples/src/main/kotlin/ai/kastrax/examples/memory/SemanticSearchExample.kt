...
import ai.kastrax.memory.impl.OpenAIEmbeddingGenerator
...
fun main() = runBlocking {
    // 替换为你的OpenAI API密钥
    val apiKey = System.getenv("OPENAI_API_KEY") ?: throw IllegalArgumentException("请设置OPENAI_API_KEY环境变量")
    
    println("KastraX 语义搜索示例")
    println("-------------------")
    
    // 创建OpenAI嵌入生成器
    val embeddingGenerator = OpenAIEmbeddingGenerator(apiKey)
