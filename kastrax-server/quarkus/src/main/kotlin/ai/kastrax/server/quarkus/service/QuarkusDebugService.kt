...
import ai.kastrax.server.quarkus.repository.BreakpointRepository
import ai.kastrax.server.quarkus.repository.DebugSessionRepository
...
@ApplicationScoped
class QuarkusDebugService : DebugApi {
    
    @Inject
    lateinit var workflowRepository: WorkflowRepository
    
    @Inject
    lateinit var breakpointRepository: BreakpointRepository
    
    @Inject
    lateinit var debugSessionRepository: DebugSessionRepository
