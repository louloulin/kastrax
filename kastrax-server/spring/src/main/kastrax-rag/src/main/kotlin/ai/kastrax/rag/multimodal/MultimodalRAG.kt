...
class MultimodalRAG(
    ...
    private fun createQueryDocument(
        ...
        // 确定文档类型
        val mediaType = when {
            imageUrl != null && audioUrl == null && videoUrl == null -> MultimodalDocumentType.TEXT_IMAGE
            imageUrl == null && audioUrl != null && videoUrl == null -> MultimodalDocumentType.TEXT_AUDIO
            imageUrl == null && audioUrl == null && videoUrl != null -> MultimodalDocumentType.TEXT_VIDEO
            imageUrl != null || audioUrl != null || videoUrl != null -> MultimodalDocumentType.MULTIMODAL
