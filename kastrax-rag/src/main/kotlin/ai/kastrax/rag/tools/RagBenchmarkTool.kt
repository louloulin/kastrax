...
import ai.kastrax.evals.benchmark.Benchmark
import ai.kastrax.evals.benchmark.TestCase
import ai.kastrax.evals.benchmark.benchmark
import ai.kastrax.evals.benchmark.testCase
import ai.kastrax.evals.benchmark.testSuite
        ...
        val testSuite = testSuite<String, String> {
            ...
            testCases.forEach { testCase ->
                testCase {
                    ...
                    this.input = testCase.query
                    this.expectedOutput = testCase.groundTruth
                    
                    // 添加自定义属性
                    this.properties["ragTestCase"] = testCase
                }
            }
        }
...
class RagBenchmark(
    ...
    suspend fun run(
        ...
        logger.info { "Running RAG benchmark: ${benchmark.name}" }
