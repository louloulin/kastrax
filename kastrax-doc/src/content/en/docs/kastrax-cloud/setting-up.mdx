...
description: Configuration steps for Kastrax Cloud projects
---
...
2. **Add a New Project**
   ...
   ![Kastrax Cloud Projects Dashboard](/image/cloud-agents.png)
...
4. **Configure Deployment Details**
   ...
   - **Kastrax Directory**: Specify where Kastrax files are located (defaults to `src/kastrax`)
...
- **Domains**: URLs for accessing your deployed application
  - Format: `https://[project-name].kastrax.cloud`
  - Format: `https://[random-id].kastrax.cloud`
...
1. The custom domain assigned to your project: `https://[project-name].kastrax.cloud`
