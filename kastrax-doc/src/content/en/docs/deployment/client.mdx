...
<Tabs items={["Kotlin", "Java", "JavaScript"]}>
  <Tabs.Tab>
```kotlin filename="KotlinClient.kt" copy
...
```
  ...
  <Tabs.Tab>
```java filename="JavaClient.java" copy
import ai.kastrax.client.KastraxClient;
...
```
  ...
  <Tabs.Tab>
```typescript filename="JavaScriptClient.ts" copy
...
<Tabs items={["Kotlin", "Java", "JavaScript"]}>
  <Tabs.Tab>
```kotlin filename="KotlinExample.kt" copy
import ai.kastrax.client.KastraxClient
...
```
  ...
  <Tabs.Tab>
```java filename="JavaExample.java" copy
import ai.kastrax.client.KastraxClient;
...
```
  ...
  <Tabs.Tab>
```typescript filename="JavaScriptExample.ts" copy
import { KastraxClient } from "@kastrax/client-js";
...
<Tabs items={["Kotlin", "Java", "JavaScript"]}>
  <Tabs.Tab>
```kotlin filename="AgentOperations.kt" copy
// Get an agent by ID
val agent = client.getAgent("assistant")
...
```
  ...
  <Tabs.Tab>
```java filename="AgentOperations.java" copy
// Get an agent by ID
Agent agent = client.getAgent("assistant");
...
```
  ...
  <Tabs.Tab>
```typescript filename="AgentOperations.ts" copy
// Get an agent by ID
const agent = client.getAgent("assistant");
...
<Tabs items={["Kotlin", "Java", "JavaScript"]}>
  <Tabs.Tab>
```kotlin filename="ErrorHandling.kt" copy
import ai.kastrax.client.KastraxClient
...
```
  ...
  <Tabs.Tab>
```java filename="ErrorHandling.java" copy
import ai.kastrax.client.KastraxClient;
import ai.kastrax.client.agent.Agent;
import ai.kastrax.client.exception.KastraxApiException;
import ai.kastrax.client.exception.KastraxNetworkException;
...
```
  ...
  <Tabs.Tab>
```typescript filename="ErrorHandling.ts" copy
...
<Tabs items={["Kotlin", "Java", "JavaScript"]}>
  <Tabs.Tab>
```kotlin filename="ConfigManagement.kt" copy
import ai.kastrax.client.KastraxClient
...
```
  ...
  <Tabs.Tab>
```java filename="ConfigManagement.java" copy
import ai.kastrax.client.KastraxClient;
import ai.kastrax.client.KastraxClientConfig;
...
```
  ...
  <Tabs.Tab>
```typescript filename="ConfigManagement.ts" copy
import { KastraxClient } from "@kastrax/client-js";
