---
title: Storage in Kastrax | Kastrax Docs
description: Overview of Kastrax's storage system and data persistence capabilities.
---
...
`KastraxStorage` provides a unified interface for managing:
...
- **Traces**: OpenTelemetry traces from all components of Kastrax
