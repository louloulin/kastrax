---
title: "Data Mapping with Workflow Variables | Kastrax Docs"
description: "Learn how to use workflow variables to map data between steps and create dynamic data flows in your Kastrax workflows."
---

# Data Mapping with Workflow Variables ✅

Workflow variables in Kastrax provide a powerful mechanism for mapping data between steps, allowing you to create dynamic data flows and pass information from one step to another.

## Understanding Workflow Variables ✅

In Kastrax workflows, variables serve as a way to:
...
When a workflow executes, Kastrax resolves variables at runtime by:
...
Kastrax provides type safety for variable mappings when using TypeScript:
