---
title: "Runtime variables - dependency injection | Workflows | Kastrax Docs"
description: Learn how to use Kastrax's dependency injection system to provide runtime configuration to workflows and steps.
---

# Workflow Runtime Variables ✅

Kastrax provides a powerful dependency injection system that enables you to configure your workflows and steps with runtime variables. This feature is essential for creating flexible and reusable workflows that can adapt their behavior based on runtime configuration.
...
import { RuntimeContext } from "@kastrax/core/di";
...
```typescript
import { Step } from "@kastrax/core/workflow";
import { z } from "zod";
