...
Kastrax agents can be enhanced with voice capabilities, allowing them to speak responses and listen to user input. You can configure an agent to use either a single voice provider or combine multiple providers for different operations.
...
|----------|---------|----------|-----------|
| OpenAI | `@kastrax/voice-openai` | TTS, STT | [Documentation](/reference/voice/openai) |
| OpenAI Realtime | `@kastrax/voice-openai-realtime` | Realtime speech-to-speech | [Documentation](/reference/voice/openai-realtime) |
| ElevenLabs | `@kastrax/voice-elevenlabs` | High-quality TTS | [Documentation](/reference/voice/elevenlabs) |
| PlayAI | `@kastrax/voice-playai` | TTS | [Documentation](/reference/voice/playai) |
| Google | `@kastrax/voice-google` | TTS, STT | [Documentation](/reference/voice/google) |
| Deepgram | `@kastrax/voice-deepgram` | STT | [Documentation](/reference/voice/deepgram) |
| Murf | `@kastrax/voice-murf` | TTS | [Documentation](/reference/voice/murf) |
| Speechify | `@kastrax/voice-speechify` | TTS | [Documentation](/reference/voice/speechify) |
| Sarvam | `@kastrax/voice-sarvam` | TTS, STT | [Documentation](/reference/voice/sarvam) |
| Azure | `@kastrax/voice-azure` | TTS, STT | [Documentation](/reference/voice/kastrax-voice) |
| Cloudflare | `@kastrax/voice-cloudflare` | TTS | [Documentation](/reference/voice/kastrax-voice) |
