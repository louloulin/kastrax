---
title: "Using Agent Memory | Agents | Kastrax Docs"
description: Documentation on how agents in Kastrax use memory to store conversation history and contextual information.
---

# Agent Memory ✅

Agents in Kastrax can leverage a powerful memory system to store conversation history, recall relevant information, and maintain persistent context across interactions. This allows agents to have more natural, stateful conversations.
...
Keep exploring Kastrax's [memory capabilities](/docs/memory/overview) like threads, conversation history, semantic recall, and working memory.
