...
- **Tool Integration**: Use built-in tools or create custom tools for specific tasks
- **LLM Integration**: Work with various LLM providers including DeepSeek, OpenAI, Anthropic, and Google Gemini
- **RAG Support**: Incorporate knowledge from documents and other data sources
- **Actor Model**: Build distributed agent systems using the actor model
