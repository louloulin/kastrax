...
The Kastrax tools system consists of several components:

1. **Tool Definition**: How tools are defined and registered
2. **Tool Execution**: How tools are executed by agents
3. **Tool Parameters**: How tool parameters are defined and validated
4. **Tool Results**: How tool results are processed and returned
