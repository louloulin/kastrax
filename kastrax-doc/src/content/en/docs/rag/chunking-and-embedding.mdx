---
title: Chunking and Embedding Documents | RAG | Kastrax Docs
description: Guide on chunking and embedding documents in Kastrax for efficient processing and retrieval.
---
...
Use `chunk` to split documents into manageable pieces. Kastrax supports multiple chunking strategies optimized for different document types:
...
Transform chunks into embeddings using your preferred provider. Kastrax supports many embedding providers, including OpenAI and Cohere:
