---
title: "Storing Embeddings in A Vector Database | Kastrax Docs"
description: Guide on vector storage options in Kastrax, including embedded and dedicated vector databases for similarity search.
---
...
After generating embeddings, you need to store them in a database that supports vector similarity search. Kastrax provides a consistent interface for storing and querying embeddings across different vector databases.
