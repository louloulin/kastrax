        ...
        extend(
            ...
            object : CompletionProvider<CompletionParameters>() {
                override fun addCompletions(
                    ...
                    val currentLine = document.getText(com.intellij.openapi.util.TextRange(lineStartOffset, offset))
                    
                    // 获取前几行作为上下文
                    val contextStartLine = maxOf(0, lineNumber - 5)
                    val contextStartOffset = document.getLineStartOffset(contextStartLine)
                    val context = document.getText(com.intellij.openapi.util.TextRange(contextStartOffset, offset))
