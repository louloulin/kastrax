...
class EnhancedChatPanel(
    ...
    private fun createToolbar(): JComponent {
        ...
        // 添加新建会话按钮
        val newConversationAction = object : com.intellij.openapi.actionSystem.AnAction("新建会话", "创建新的会话", AllIcons.General.Add) {
            override fun actionPerformed(e: com.intellij.openapi.actionSystem.AnActionEvent) {
                ...
                // 通知父容器刷新
                SwingUtilities.getWindowAncestor(this@EnhancedChatPanel)?.dispatchEvent(
                    com.intellij.openapi.actionSystem.ex.ActionManagerEx.getInstanceEx().getDataContextChangeEvent()
                )
            }
        }
        ...
        // 添加清空会话按钮
        val clearConversationAction = object : com.intellij.openapi.actionSystem.AnAction("清空会话", "清空当前会话", AllIcons.Actions.GC) {
            override fun actionPerformed(e: com.intellij.openapi.actionSystem.AnActionEvent) {
        ...
        // 添加保存会话按钮
        val saveConversationAction = object : com.intellij.openapi.actionSystem.AnAction("保存会话", "保存当前会话", AllIcons.Actions.MenuSaveall) {
            override fun actionPerformed(e: com.intellij.openapi.actionSystem.AnActionEvent) {
                // 保存会话逻辑
        ...
        // 添加创建检查点按钮
        val createCheckpointAction = object : com.intellij.openapi.actionSystem.AnAction("创建检查点", "创建代码检查点", AllIcons.Vcs.Snapshot) {
            override fun actionPerformed(e: com.intellij.openapi.actionSystem.AnActionEvent) {
