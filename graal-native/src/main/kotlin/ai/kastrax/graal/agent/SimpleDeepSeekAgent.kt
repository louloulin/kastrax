...
/**
 * 简化版本的 DeepSeek Agent 示例
 * 不使用 Kotlin 序列化，专为 GraalVM Native Image 设计
 */
object SimpleDeepSeekAgent {
    ...
    fun run(apiKey: String = "", interactive: Boolean = true) {
        println("启动简化版 DeepSeek Agent 示例...")
    ...
    private fun runInteractiveSession() {
        println("欢迎使用简化版 DeepSeek Agent！")
        ...
        println("感谢使用简化版 DeepSeek Agent！")
    }
    ...
    private fun runSingleExample() {
        ...
        println("简化版 DeepSeek Agent 示例演示：")
        println()
    ...
    private fun processInput(input: String, memory: MutableMap<String, String>): String {
        ...
        return when {
            input.contains("你好") || input.contains("介绍") -> {
                "你好！我是简化版 DeepSeek 助手，一个为 GraalVM Native Image 设计的智能助手。我可以回答问题、执行计算和提供当前日期时间。很高兴为你服务！"
            }
            ...
            input.contains("我的名字") -> {
                ...
                "我理解你的问题是关于 '$input'。作为一个简化版的 DeepSeek 助手，我的回答能力有限。请尝试问我关于时间、计算或者其他简单问题。"
            }
        }
    }
